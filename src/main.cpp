...
uint256 hashGenesisBlock("0x1cc902dd0591398a94054d7259bf72d005d99cf1c911338f1f55553f735dea7f");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 8400); // 

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Credits: 1 day
static const int64 nTargetSpacing = 1 * 45; // Credits: 45 seconds
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Credits: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1cc902dd0591398a94054d7259bf72d005d99cf1c911338f1f55553f735dea7f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "DRNA National currency--1-14-18,Google pulls Addiction rehab ads worldwide";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("134484710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515992592;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1634357;
        ...
        assert(block.hashMerkleRoot == uint256("0x78e3ae8178caa59a43285a8a537912d690059f50dbee09af4b4498e0c515172a"));
...
unsigned char pchMessageStart[4] = { 0xab, 0xc2, 0xb6, 0xdb }; // Credits: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CreditsMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CreditsMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CreditsMiner(CWallet *pwallet)
{
    printf("CreditsMiner started\n");
    ...
    try { loop {
        ...
        printf("Running CreditsMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CreditsMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CreditsMiner, pwallet));
}
